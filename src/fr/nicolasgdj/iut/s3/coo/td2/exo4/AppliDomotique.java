...
import fr.nicolasgdj.iut.s3.coo.td2.exo4.objets.factory.ConnectableFactory;
...
public class AppliDomotique {
	...
	public static void attacher() {
		...
		for(Connectable c : objetsConnectee) {
			System.out.println("Faut-il attacher " + c + " ? (false=non, true=oui)");
	...
	public static void dettacher() {
		...
		for(Connectable c : objetsConnectee) {
			System.out.println("Faut-il déttacher " + c + " ? (false=non, true=oui)");
			if(scanner.hasNext() && scanner.nextBoolean()) {
